module github.com/tsuru/acl-api
...
require (
	...
	github.com/tsuru/tsuru v0.0.0-20220517005412-3556c91893d4
...
replace gopkg.in/ahmetb/go-linq.v3 => github.com/ahmetb/go-linq v3.0.0+incompatible
